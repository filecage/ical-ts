...
describe('iterateReccurences Tests', () => {
    ...
    const rruleSamples: [string,string][] = [
        ...
        ['Every Tuesday in February', 'FREQ=WEEKLY;BYDAY=TU;BYMONTH=2;COUNT=12'],
        ...
        ['First workday of month using SETPOS', 'FREQ=MONTHLY;BYDAY=MO,TU,WE,TH,FR;BYSETPOS=1;COUNT=6'],
